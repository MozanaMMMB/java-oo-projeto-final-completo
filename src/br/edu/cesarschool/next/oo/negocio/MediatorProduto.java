...
import br.edu.cesarschool.next.oo.dao.DAOGenericoTipoParametrizado;
...
public class MediatorProduto {
	...
	private DAOGenericoTipoParametrizado<Produto> daoProd 
		= new DAOGenericoTipoParametrizado<>(Produto.class);
	...
	public List<Produto> gerarRelatorioGeral() {
		List<Produto> listaProd =  daoProd.buscarTodos();		
